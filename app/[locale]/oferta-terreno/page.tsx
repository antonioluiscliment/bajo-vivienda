...
const T = {
  es: {
    ...
    s4p: "En el actual estado de desarrollo del Sector, la oferta de terreno tiene un precio por metro cuadrado bruto desde 300 €.",
    s4stat: "300 €/m²",
    s4statL: "Precio bruto de suelo, desde",
    s5kicker: "05 — Opción de compra",
    s5h2: "Opción de compra sobre el precio fijado",
    s5p: "Además de la venta directa, cabe negociar una opción de compra sobre el conjunto de parcelas, manteniendo fijo el precio de venta en 300 €/m² durante todo el tiempo de vigencia de la opción. El precio de esa opción equivale a aplicar el Euríbor sobre el precio de venta: con el Euríbor situado actualmente en torno al 3%, resulta en 9 €/m² al año.",
    s5stat1: "9 €/m² al año",
    ...
    s6p: "Como alternativa a la opción ligada al Euríbor, cabe negociar una opción de compra cuya prima —el precio de la propia opción— equivale al 1% anual del precio inicial de venta, actualmente 3 €/m². El precio de ejercicio, es decir, el precio de venta del terreno, será de 300 €/m², actualizado por la variación del IPC desde la fecha de constitución de la opción hasta el momento de la venta efectiva.",
    s6stat1: "3 €/m² al año",
    s6stat1L: "Prima de la opción (1% anual sobre 300 €/m²)",
    s6stat2: "300 €/m² + IPC",
  ...
  en: {
    ...
    s4p: "At the Sector's current stage of development, the land on offer is priced from €300 per gross square metre.",
    s4stat: "€300/m²",
